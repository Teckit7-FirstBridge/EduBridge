...
import com.ll.edubridge.domain.course.course.entity.dto.CourseDTO;
import com.ll.edubridge.domain.course.course.entity.service.CourseService;
...
@Tag(name = "ApiV1CourseController", description = "글 CRUD 컨트롤러")
...
public class ApiV1CourseController {
    ...
    public RsData<GetCoursesResponsebody> getCourses(){
        ...
        return RsData.of("200-1", "성공", new GetCoursesResponsebody(
                courses.stream().map(CourseDTO::new).toList()
        ));
    }
